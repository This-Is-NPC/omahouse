...
// One binary, two archives, eight suites and the smoke test.
//
...
// a .pro and a binary per suite -- links the same two archives nine times to
// assert nine groups of things about them.
