...
// One binary, two archives, thirteen suites and the smoke test.
//
...
// a .pro and a binary per suite -- links the same two archives fourteen times
// to assert thirteen groups of things about them.
