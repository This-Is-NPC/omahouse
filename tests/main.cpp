...
// One binary, two archives, seven suites and the smoke test.
//
...
// a .pro and a binary per suite -- links the same two archives eight times to
// assert eight groups of things about them.
