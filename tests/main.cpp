...
// One binary, two archives, nine suites and the smoke test.
//
...
// a .pro and a binary per suite -- links the same two archives ten times to
// assert ten groups of things about them.
