...
[The defect](what-does-not-work.md#5-the-filter-narrows-all-four-lists-at-once).
...
[The defect](what-does-not-work.md#7-a-scope-nothing-can-name-has-no-screen-in-the-window).
